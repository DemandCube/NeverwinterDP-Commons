...
public class ReferenceOpenHashBigSet <K> extends AbstractReferenceSet <K> implements java.io.Serializable, Cloneable, Hash, Size64 {
 ...
 public boolean add( final K k ) {
  final long h = ( (k) == null ? 0x810879608e4259ccL : it.unimi.dsi.fastutil.HashCommon.murmurHash3( (long)( System.identityHashCode(k) ^ mask ) ) );
  // The starting point.
 ...
 protected final long shiftKeys( long pos ) {
  ...
  for(;;) {
   ...
   while( BooleanBigArrays.get( used, pos ) ) {
    slot = ( (ObjectBigArrays.get( key, pos )) == null ? 0x810879608e4259ccL : it.unimi.dsi.fastutil.HashCommon.murmurHash3( (long)( System.identityHashCode(ObjectBigArrays.get( key, pos )) ^ mask ) ) ) & mask;
 ...
 protected void rehash( final long newN ) {
  ...
  for( long i = size; i-- != 0; ) {
   ...
   k = key[ base ][ displ ];
   h = ( (k) == null ? 0x810879608e4259ccL : it.unimi.dsi.fastutil.HashCommon.murmurHash3( (long)( System.identityHashCode(k) ^ mask ) ) );
   // The starting point.
