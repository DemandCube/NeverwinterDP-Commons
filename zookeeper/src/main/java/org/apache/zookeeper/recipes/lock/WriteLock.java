...
public class WriteLock extends ProtocolSupport {
   ...
   * @param acls the acls that you want to use for all the paths, if null world read/write is used.
   */
  public WriteLock(ZooKeeper zookeeper, String dir, List<ACL> acl) {
    super(zookeeper);
    this.dir = dir;
    if (acl != null) setAcl(acl);
   ...
   * this also removes your request in the queue for locking in case you do not
   ...
   * was acquired. Note that the exclusive lock may be acquired some time later
   * after this method has been invoked due to the current lock owner going
   * away.
   */
